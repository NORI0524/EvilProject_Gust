    ...
    public class Language
    {
        ...
        private static readonly GUIContent[][] LanguageHelps = new GUIContent[(int)LanguageType.Total][]
        {
            ...
            new GUIContent[]
            {
                ...
                new GUIContent("Template", "Loads a list from a hand pose template file."),
                ...
                new GUIContent("Template", "Loads a list from a blend shape template file."),
            ...
            new GUIContent[]
            {
                ...
                new GUIContent("Template", "ハンドポーズテンプレートファイルからリストにロードします。"),
                ...
                new GUIContent("Template", "ブレンドシェイプテンプレートファイルからリストにロードします。"),
